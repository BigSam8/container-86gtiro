...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-86gtiro.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-86gtiro.containers.anotherwebservice.com/
...
```
git clone git@github.com:BigSam8/container-86gtiro.git
cd container-86gtiro
```
...
```
docker attach container-86gtiro
```
